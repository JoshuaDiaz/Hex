...
![Choose the board size!](https://github.com/JoshuaDiaz/Hex/blob/master/BoardSize.PNG "Choose the board size!")
...
![The AI won the coin flip](https://github.com/JoshuaDiaz/Hex/blob/master/coinflip.PNG "The AI won the coin flip")
...
![x = 3, y = 1](https://github.com/JoshuaDiaz/Hex/blob/master/input.PNG "x = 3, y = 1")
